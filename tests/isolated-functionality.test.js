 ...
 * Tests core functionality without loading HTML files
 */

describe('Isolated Functionality Tests', () => {
  beforeEach(() => {
    // Clear localStorage
    localStorage.clear();
  ...
  describe('Ion Formation Reset Functions', () => {
    ...
    test('should reset chlorine demo with correct electron configuration', () => {
      // Test the reset function logic directly
      ...
      expect(slot3s2).toBeTruthy();
      expect(slot3p1).toBeTruthy();
      expect(slot3p2).toBeTruthy();
      expect(slot3p3).toBeTruthy();
      expect(slot3p4).toBeTruthy();
      expect(slot3p5).toBeTruthy();
  ...
  describe('Visual Improvements', () => {
    test('should apply tight spacing styles', () => {
      ...
      expect(testElement.style.marginBottom).toBe('0px');
      expect(testElement.style.padding).toBe('2px');
      expect(testElement.style.gap).toBe('0px');
